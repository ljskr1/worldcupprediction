...
| Pos | Team | Pld | W | D | L | GF | GA | GD | Pts |
|---|---|---|---|---|---|---|---|---|---|
| 1 | 🇨🇴 Colombia ✅ | 3 | 2 | 0 | 1 | 4 | 3 | +1 | **6** |
| 2 | 🇨🇩 Congo DR ✅ | 3 | 1 | 2 | 0 | 4 | 2 | +2 | **5** |
...
| 2 | 🇬🇭 Ghana ✅ | 3 | 1 | 1 | 1 | 3 | 4 | -1 | **4** |
| 3 | 🇵🇦 Panama ✅ | 3 | 1 | 0 | 2 | 2 | 2 | +0 | **3** |
| 4 | 🇭🇷 Croatia ❌ | 3 | 1 | 0 | 2 | 4 | 6 | -2 | **3** |
...
| Match 3 | 🇧🇷 Brazil vs 🇰🇷 South Korea | **🇧🇷 Brazil** | 58.8% |
| Match 4 | 🇺🇸 United States vs 🇯🇴 Jordan | **🇺🇸 United States** | 75.8% |
| Match 5 | 🇩🇪 Germany vs 🇵🇾 Paraguay | **🇩🇪 Germany** | 71.5% |
| Match 6 | 🇯🇵 Japan vs 🇵🇦 Panama | **🇯🇵 Japan** | 64.0% |
| Match 7 | 🇪🇬 Egypt vs 🇨🇮 Côte d'Ivoire | **🇨🇮 Côte d'Ivoire** | 53.2% |
| Match 8 | 🇨🇻 Cabo Verde vs 🇸🇪 Sweden | **🇸🇪 Sweden** | 70.0% |
...
| Match 4 | 🇨🇮 Côte d'Ivoire vs 🇸🇪 Sweden | **🇨🇮 Côte d'Ivoire** | 53.3% |
...
| Match 8 | 🇫🇷 France vs 🇨🇩 Congo DR | **🇫🇷 France** | 79.6% |

### Quarterfinals
| Match | Matchup | Predicted Winner | Win Probability |
|---|---|---|---|
| Match 1 | 🇪🇸 Spain vs 🇧🇷 Brazil | **🇪🇸 Spain** | 54.8% |
| Match 2 | 🇩🇪 Germany vs 🇨🇮 Côte d'Ivoire | **🇩🇪 Germany** | 100.0% |
